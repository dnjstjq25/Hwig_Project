            ...
            <ul>
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar3.png" class="img-circle" alt="">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar1.png" class="img-circle" alt="">
                      <i class="on animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar2.png" class="img-circle" alt="">
                      <i class="on animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar4.jpg" class="img-circle" alt="">
                      <i class="on animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar5.png" class="img-circle" alt="">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar6.png" class="img-circle" alt="">
                      <i class="on animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar7.png" class="img-circle" alt="">
                      <i class="on animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar8.png" class="img-circle off" alt="">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-3">
                            <span class="avatar">
                    <img src="../resources/assets/img/avatar9.png" class="img-circle off" alt="">
                      <i class="off animated bounceIn"></i>
                    </span>
                        </div>
                        <div class="col-md-9">
